...
from app.routes import auth, products, cart, orders, admin, payments, admin  # Import payments routes
import logging
...
app.include_router(admin.router)  # Keep only this one - prefix already in admin.py
